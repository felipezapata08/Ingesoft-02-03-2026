...
Permite a un paciente cancelar una cita médica previamente agendada en el sistema.
...
RNF-02	Seguridad	Los datos médicos deben almacenarse de forma confidencial y cumplir con las normativas de protección de datos vigentes.
RNF-03	Rendimiento	La cancelación de la cita debe procesarse en un tiempo máximo de 2 segundos.
RNF-04	Usabilidad	La interfaz debe ser clara e intuitiva, permitiendo cancelar la cita en un máximo de 3 pasos.
Precondición
